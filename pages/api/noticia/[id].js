// pages/api/noticia/[id].js
//
// Next.js API Route (Pages Router). Next.js la detecta y publica sola en
// /api/noticia/:id — no requiere nada en vercel.json para existir.
//
...
// llegan en el primer HTML. Por eso esto corre en el servidor (no en el
// navegador) y arma esas etiquetas con los datos reales de la noticia
// ANTES de responder.
//
// Usa el mismo API key público de Firebase que ya usa diario.html para
// leer Firestore (las reglas de seguridad del proyecto ya permiten
// lectura pública de "noticias"), así que no necesita variables de
// entorno nuevas ni service account.
